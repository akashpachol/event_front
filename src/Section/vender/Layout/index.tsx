...
<p className='me-5 text-2xl text-green-600 cursor-pointer' onClick={()=>   navigate("/vender/chat")}><IoChatbubbleEllipsesOutline /></p>
      ...
      {user.venderToken ?(<div className="relative ml-3" ref={dropdownRef}>
                    ...
                    {dropdownOpen && (
                      ...
                      >
                        ...
                        <button
                        onClick={()=>navigate('/vender/settings')}
    ...
    <aside
      ...
      }fixed transition  ease-in-out duration-700 z-40 flex-col h-screen bg-gradient-to-r from-green-400 via-green-500 to-green-600  hover:bg-gradient-to-br`}
    >
      ...
      >
        <NavLink  to={'/vender'} className={({ isActive, isPending }) =>
    isPending ? "" : isActive ? "bg-red-500" : ""
  }>
        <div className="hover:ml-4 mt-5 w-full text-white  hover:text-black  bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br  p-2 pl-8 rounded-lg transform ease-in-out duration-500 flex flex-row items-center space-x-3 border" >
          <RiHome2Line className="w-4 h-4" />
          <div className="text-white hover:text-black">Home</div>
        </div></NavLink>
        <NavLink  to={'/vender/venders'} >
      ...
      >
        <div className="hover:ml-4 justify-end pr-5 text-white hover:text-purple-500 dark:hover:text-blue-500 w-full bg-gradient-to-r from-green-500 via-green-600 to-green-700 hover:bg-gradient-to-br p-3 rounded-full transform ease-in-out duration-300 flex">
          <RiHome2Line className="w-4 h-4" />
        </div>
