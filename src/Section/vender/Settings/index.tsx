...
import { editProfileImg, getUserDeatails } from "../../../service/api/vender/apiMethod";
...
const getDetails=()=>{
  getUserDeatails(vender.venderId)
  ...
  return (
    <div className="h-screen flex flex-col ">
      ...
      <Sidebar />
        <div className="sm:w-2/3 lg:pe-24 ">
        <div
  className="w-full  pt-5 border-2 "
  style={{ background: 'linear-gradient(to right, rgb(101, 217, 90), rgba(224, 252, 255, 0.26))' }}
>
  ...
  <button className="user_button  h-8 pt-1" onClick={() => setShowModal1(true)}  >Edit Profile</button>
</div>
    </div>
</div>
