...
const getDetails=()=>{
  getUserDeatails(manager.managerId)
  ...
  const getCroppedFile = (croppedData: string) => {
    ...
    editProfileImg(manager.managerId,croppedData)
  ...
  return (
    <div className="h-screen flex flex-col ">
      ...
      <Sidebar />
        <div className="sm:w-2/3 w-96 lg:pe-24 ">
        <div
  className="w-full  pt-5 border-2"
  style={{ background: 'linear-gradient(to right, rgb(82, 179, 151), rgba(224, 252, 255, 0.26))' }}>
  ...
  <button className="manager_button  h-8 pt-1" onClick={() => setShowModal1(true)}  >Edit Profile</button>
</div>
    </div>
</div>
