    ...
    import {  blockOffer, getOffer } from "../../../service/api/manager/apiMethod";
...
import EditOffer from "./EditOffer";
    ...
    const Offer:React.FC = () => {
      ...
      const getDetails = async () => {
        try {
          const response = await getOffer(manager.managerId);
      ...
      return (
        <div className="mx-5 ">
          <div className="flex justify-between">
            ...
            />
            <button className='manager_button my-6'    onClick={toggleModal }>Add Offer</button>
          </div>
