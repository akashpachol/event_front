...
import { addOffer } from '../../../service/api/manager/apiMethod';
...
const AddOffer: React.FC<AddOfferProps> = ({ isModalOpen, setIsModalOpen }) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values, { resetForm }) => {
            const data: offer = {
                ...values,
                discountedManager: managerData.managerId,
            };
                    ...
                    <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div className="p-4 md:p-5">
                            <form className="space-y-4" onSubmit={formik.handleSubmit}>
                                ...
                                <button type="submit" className="manager_button w-full">Submit</button>
                            </form>
                        </div>
                    </div>
                </div>
